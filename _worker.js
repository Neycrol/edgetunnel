            ...
            if (response.status === 'fulfilled') {
                ...
                if (lines[0].split(',').length > 3) {
                    ...
                    for (let i = 1; i < lines.length; i++) {
                        ...
                        if (columns) {
                            let parsedIP = columns;
                            // 支持 IPv6
                            if (parsedIP.includes(':') && !parsedIP.startsWith('[') && !parsedIP.endsWith(']')) {
                                parsedIP = `[${parsedIP}]`;
                            }
                            newapi += `${parsedIP}:${测速端口}${节点备注 ? `#${节点备注}` : ''}\n`;
                            if (api[index].includes('proxyip=true')) proxyIPPool.push(`${parsedIP}:${测速端口}`);
                        }
                    }
                } else {
        ...
        try {
            ...
            for (let i = 1; i < lines.length; i++) {
                ...
                if (columns[tlsIndex].toUpperCase() === tls && parseFloat(columns[speedIndex]) > DLS) {
                    let ipAddress = columns[ipAddressIndex];
                    // 支持 IPv6
                    if (ipAddress.includes(':') && !ipAddress.startsWith('[') && !ipAddress.endsWith(']')) {
                        ipAddress = `[${ipAddress}]`;
                    }
        ...
        const html = `
            ...
            <body>
                ...
                <div id="noticeContent" class="notice-content">
                    ${decodeURIComponent(atob(''))}
                </div>
                <div class="editor-container">
                    ${hasKV ? `
                    <textarea class="editor"
                        placeholder="${decodeURIComponent(atob(''))}"
